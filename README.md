<h1 align="center">Bonjour 👋, je suis Arnaud Moreau</h1>

<h3 align="center">
  Ingénieur Logiciel orienté IA — Deep Learning, IA Agentique & MLOps
</h3>
...
- 🧠 **IA & Deep Learning** : PyTorch, TensorFlow, CNN, Transformers, modèles teacher/student
- 🤖 **IA agentique & automatisation** : LangChain, LangGraph, agents, workflows automatisés, orchestration d’outils
- 👁️ **Computer Vision** : classification d’images, détection d’images générées, Grad-CAM, analyse de représentations
...
- 🔎 **IA appliquée & NLP**  
  Expérimentations avec spaCy, Transformers, RAG, recherche sémantique et automatisation de traitements textuels.
...
- Kubernetes, GitOps et observabilité
